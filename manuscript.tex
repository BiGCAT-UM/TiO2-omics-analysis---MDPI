...
\Author{\hl{Laurent A. Winckers} %MDPI: Please carefully check the accuracy of names and affiliations.
 $^{1}$\orcidA{}, Chris \hl{T.} %MDPI: we added dot for middle name abbreviation, please confirm.
...
BiGCaT, NUTRIM School of Nutrition and Translational Research in Metabolism, Maastricht \hl{University}; %MDPI: PLEASE add city, state abbreviation postcode, country.
...
\\
$^{2}$ \quad Maastricht Centre for Systems Biology (MaCSBio), Maastricht \hl{University}}
...
fairness  %check meaning has been retained
...
It is noticeable that there are only two oxidative stress pathways, i.e.,~Detoxification of Reactive Oxygen Species~(wikipathways\hl{: } %MDPI: added space, please confirm.
...
Interestingly, the low concentration pathways related to DNA-damage and repair show up in the results. %check meaning has been retained
...
\includegraphics[width=1\linewidth]{fig2.pdf}
  \caption{Pathway-gene networks of altered toxicity-related pathways.
   ...
   red %check meaning has been retained
...
\toprule
\multirow{2}{*}{} & \multicolumn{5}{c}{\textbf{Number of Pathways   Based on}} \\ \cmidrule{2-6} 
 & \begin{tabular}[c]{@{}c@{}}\textbf{ORA} \\ \textbf{(Adjust \emph{p} Value \textless~0.05)}\end{tabular} & \begin{tabular}[c]{@{}c@{}}\textbf{80\%} \\ \textbf{Gene Overlap}\end{tabular} & \begin{tabular}[c]{@{}c@{}}\textbf{70\%} \\ \textbf{Gene Overlap}\end{tabular} & \begin{tabular}[c]{@{}c@{}}\textbf{60\%} \\ \textbf{Gene Overlap}\end{tabular} & \begin{tabular}[c]{@{}c@{}}\textbf{50\%} \\ \textbf{Gene Overlap}\end{tabular} \\ \midrule
...
\newblock  Available online: \url{https://wikipathways.org/instance/WP2824_r117697} \hl{(accessed on). } %Please add accessed date.
...
\newblock Available online: \url{https://wikipathways.org/instance/WP408_r106567} \hl{(accessed on). } %Please add accessed date. 
...
\newblock Available online: \url{https://wikipathways.org/instance/WP127_r116634} \hl{(accessed on). } %Please add accessed date.
...
\newblock Available online: \url{https://wikipathways.org/instance/WP49_r116633} \hl{(accessed on). } %Please add accessed date. 
...
\newblock Available online: \url{https://wikipathways.org/instance/WP4155_r119086} \hl{(accessed on). } %Please add accessed date. 
...
\newblock Available online: \url{https://wikipathways.org/instance/WP3567_r117752} \hl{(accessed on). } %Please add accessed date. 
...
\newblock Available online: \url{https://wikipathways.org/instance/WP3550_r114784} \hl{(accessed on). } %Please add accessed date. 
...
\newblock Available online: \url{https://wikipathways.org/instance/WP3543_r114907} \hl{(accessed on). } %Please add accessed date. 
...
\newblock Available online: \url{https://wikipathways.org/instance/WP254_r106302} \hl{(accessed on). } %Please add accessed date. 
...
\newblock Available online: \url{https://wikipathways.org/instance/WP364_r115943} \hl{(accessed on). } %Please add accessed date. 
...
\newblock Available online: \url{https://wikipathways.org/instance/WP3838_r114823} \hl{(accessed on). } %Please add accessed date. 
...
\newblock Available online: \url{https://wikipathways.org/instance/WP4016_r119294} \hl{(accessed on). } %Please add accessed date. 
...
\newblock DNA IR-Double Strand Breaks (DSBs) and Cellular Response via ATM
  (Homo Sapiens).  2020.
\newblock Available online: \url{https://wikipathways.org/instance/WP3959_r101991} \hl{(accessed on). } %Please add accessed date. 
...
\newblock Available online: \url{https://wikipathways.org/instance/WP531_r113644} \hl{(accessed on). } %Please add accessed date. 
...
\newblock Available online: \url{https://wikipathways.org/instance/WP1772_r116807} \hl{(accessed on). } %Please add accessed date. 
...
\newblock Available online: \url{https://wikipathways.org/instance/WP384_r117650} \hl{(accessed on). } %Please add accessed date. 
...
\newblock Available online: \url{https://wikipathways.org/instance/WP3380_r114940} \hl{(accessed on). } %Please add accessed date. 
...
\newblock Available online: \url{https://wikipathways.org/instance/WP1784_r114845} \hl{(accessed on). } %Please add accessed date. 
...
\newblock Available online: \url{https://wikipathways.org/instance/WP231_r116472} \hl{(accessed on). } %Please add accessed date. 
...
\newblock TNF-Related Weak Inducer of Apoptosis (TWEAK) Signaling Pathway (Homo
  Sapiens).  2020.
\newblock Available online: \url{https://wikipathways.org/instance/WP2036_r117848} \hl{(accessed on). } %Please add accessed date. 
...
\newblock Available online: \url{https://wikipathways.org/instance/WP2513_r110691} \hl{(accessed on). } %Please add accessed date. 

\bibitem[{Reactome Team} and Miller(2020)]{WP3381}
{Reactome Team}; Miller, R.
\newblock Mismatch Repair (Homo Sapiens). 2020.
\newblock Available online: \url{https://wikipathways.org/instance/WP3381_r113324} \hl{(accessed on). } %Please add accessed date. 
...
\newblock Available online: \url{https://wikipathways.org/instance/WP3617_r106541} \hl{(accessed on). } %Please add accessed date.  

\bibitem[{Reactome Team}(2020)]{WP4063}
{Reactome Team}.
\newblock Interleukin-10 Signaling (Homo Sapiens). 2020.
\newblock Available online: \url{https://wikipathways.org/instance/WP4063_r115095} \hl{(accessed on). } %Please add accessed date. 
...
\newblock Available online: \url{https://wikipathways.org/instance/WP4136_r118430} \hl{(accessed on).} %Please add accessed date. 
...
\newblock Platelet-Mediated Interactions with Vascular and Circulating Cells
  (Homo Sapiens). 2020.
\newblock Available online: \url{https://wikipathways.org/instance/WP4462_r102079} \hl{(accessed on). } %Please add accessed date. 
...
\newblock Available online:  \url{https://doi.org/10.5281/zenodo.5137467} \hl{(accessed on). } %Please add accessed date. 
...
\newblock Available online: \url{https://doi.org/10.5281/zenodo.5156769} \hl{(accessed on). } %Please add accessed date. 

\bibitem[{R Core Team}(2020)]{R2020}
{R Core Team}.
\newblock {\em R: A Language and Environment for Statistical Computing};
\newblock \hl{R Foundation for Statistical Computing:} %Please add the location of the publisher.
  2020.

\bibitem[{Blighe, Rana, and Lewis}(2020)]{VolcanoPlot}
\hl{Blighe, Rana and Lewis.} %MDPI: Please correct name format.
\newblock Enhanced Volcano: Publication-Ready Volcano Plots with Enhanced
  Colouring and Labeling.   2020.
\newblock Available online: \url{https://github.com/kevinblighe/EnhancedVolcano} \hl{(accessed on). } %Please add accessed date. 
...
\newblock Available online: \url{https://bioinfogp.cnb.csic.es/tools/venny/} \hl{(accessed on). } %Please add accessed date. 
